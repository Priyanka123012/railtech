class DirectPunchInModel {
  List<FRV>? fRV;
  int? statusCode;
  String? status;
  String? statusText;

  DirectPunchInModel({this.fRV, this.statusCode, this.status, this.statusText});

  DirectPunchInModel.fromJson(Map<String, dynamic> json) {
    if (json['FRV'] != null) {
      fRV = <FRV>[];
      json['FRV'].forEach((v) {
