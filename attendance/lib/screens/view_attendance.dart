...
//   final DailyAttendanceReportModel?
//       report;
//   final String?
//       img;
...
//   @override
//   _HeatMapCalendarState createState() =>
//       _HeatMapCalendarState();
// }

// class _HeatMapCalendarState
//     extends State<HeatMapCalendar> {
//   CalendarFormat
//       _calendarFormat =
...
//     if (report.ePRE != null &&
//         report.ePRE!.isNotEmpty) {
//       for (var entry in report.ePRE!) {
//         final punchDate = entry.punchDate;
//         if (punchDate != null) {
//           try {
//             final date = DateFormat('dd/MM/yyyy').parse(punchDate);
//             if (date.isBefore(_currentDate) || date.isAtSameMomentAs(_currentDate)) {
//               attendanceData[DateTime(date.year, date.month, date.day)] = entry;
//               print('Added date: ${DateFormat('dd/MM/yyyy').format(date)}, status: ${entry.attStatus}'); // Debugging line
//             }
//           } catch (e) {
...
//   Future<void> _showImageDialogs(
//       BuildContext context,
//       EPRE attendance) async {
//     String
//         formattedDate =
//         convertDate(attendance.punchDate!);
//     showDialog(
...
//                       Text("Logged Hours : ${attendance.firstPunchTime!.split(" ").last}", style: TextStyle(fontWeight: FontWeight.bold)),
//                     ],
//                   ),
//                   SizedBox(height: 10),
//                   Row(
...
//         title: Text('Attendance Log', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
...
//                       style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black38, fontSize: 16),
//                     ),
//                     SizedBox(height: 10),
//                     Divider(),
//                     Row(
...
//               }
//               final statusMessage = attendance != null ? 'Status for ${DateFormat('dd/MM/yyyy').format(selectedDay)}: ${attendance.attStatus}' : 'Status for ${DateFormat('dd/MM/yyyy').format(selectedDay)}: Absent';
...
//                   decoration: BoxDecoration(
//                     color: day.isBefore(_currentDate) || day.isAtSameMomentAs(_currentDate)
//                         ? (isSunday
//                             ? Colors.orange[200]
//                             : isPresent
//                                 ? Colors.green[200]
//                                 : isPresent && attendance?.lastLocation == ""
//                                     ? Colors.blue[200]
//                                     : Colors.red[200])
//                         : Colors.grey[300],
...
//                     child: Text(
//                       '${day.day}',
//                       style: TextStyle().copyWith(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),
//                     ),
//                   ),
//                 );
//               },
...
//                 final attendance = _getAttendanceForDate(day);
//                 // final isPresent = attendance?.attStatus == 'Present';
//                 final missed = attendance?.punchDate == DateFormat('dd/MM/yyyy').format(_currentDate) && attendance?.lastPunchTime == "" && attendance?.lastLocation == "";
//                 return Container(
//                   margin: const EdgeInsets.all(4.0),
//                   decoration: BoxDecoration(
//                     color: !missed ? Colors.green[200] : Colors.blue[200],
//                     borderRadius: BorderRadius.circular(6.0),
//                   ),
//                   child: Center(
//                     child: Text(
...
class HeatMapCalendar extends StatefulWidget {
  final DailyAttendanceReportModel? report;
  final String? img;

  HeatMapCalendar({required this.report, this.img});
...
class _HeatMapCalendarState extends State<HeatMapCalendar>
  ...
  void _populateAttendanceData(DailyAttendanceReportModel report) {
  ...
  Future<void> _showAnimatedDialog3(BuildContext context) async {
    _controller.reset();
    _controller.forward();
