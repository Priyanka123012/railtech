...
class MissedPunch extends StatefulWidget {
  const MissedPunch({super.key});

  @override
  State<MissedPunch> createState() => _MissedPunchState();
}

class _MissedPunchState extends State<MissedPunch> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //         color: Colors.white,
      //       )),
      //   title: Text('View Team (${teamAttedanceModel?.tDS?.length})',
                                      ...
                                      children: [
                                        ...
                                        onTap: () {
                                            if (tds.faceImage!.isNotEmpty &&tds.faceImage != "" &&tds.faceImage !="https://rapi.railtech.co.in/") {
                                              // Navigator.push(context,MaterialPageRoute(builder: (context) =>MissedPunchList(onedata:filteredTeamMembers[index])));
                                            } else {
                                              "Please Register your face first".showToast();
                                            }
                                          },
                                          child: Card(
                                            shadowColor: teamAttedanceModel?.tDS?[index].fullName !=""? Colors.green: Colors.red,
                                            elevation: 3,
                                            shape: RoundedRectangleBorder(),
                                            child: Padding(
                                              padding:
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Padding(  padding:EdgeInsets.all(4.0),
                                                            child: InkWell(
                                                              onTap: () =>_showImageDialog(context,tds.faceImage.toString()),
                                                              child: tds.faceImage!.isNotEmpty &&
                                                                      tds.faceImage !="" &&
                                                                      tds.faceImage !="https://rapi.railtech.co.in/"
                                                                  ? ClipRRect(
                                                                      child: Image.network((tds.faceImage.toString()),height:70,
                                                                        width:70,
                                                                        fit: BoxFit.fill,
                                                                      ),
                                                                    )
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Text("${tds.fullName ?? ""}",style: TextStyle(fontWeight:FontWeight.bold),
                                                            ),
                                                          ),
                                                          Padding(
                                                            padding:const EdgeInsets.only(left: 10),
                                                            child: Text("${tds.designation ?? ""}",style: TextStyle(color: Colors.black38),
                                                            ),
                                                          ),
                                                          Padding(padding:const EdgeInsets.only(left: 10),
                                                            child: Text("Mobile No:  ${tds.mobile ?? ""}",style: TextStyle(color: Colors.black38),
                                                            ),
                                                          ),
                                                          // Padding(
                                                          //   padding:
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  SizedBox(height:5),
                                                                  Text(
                                                                    tds.faceImage =="https://rapi.railtech.co.in/"? "Register\nYour Face": "Re-register\nYour Face",
                                                                    textAlign:TextAlign.center,
