...
class FaceTeamRegister extends StatefulWidget {
  const FaceTeamRegister({super.key});

  @override
  State<FaceTeamRegister> createState() => _FaceTeamRegisterState();
}

class _FaceTeamRegisterState extends State<FaceTeamRegister> {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          teamAttendanceModel.value =
              TeamMemberDetailsModel.fromJson(jsonResponse);
        ...
        if (filteredTeamMembers.isNotEmpty) {
          await setTeamEmpBasicId(
              filteredTeamMembers[0].eMPBasicDetailId.toString());
            ...
            children: [
              ...
              isLoading == true
                  ...
                  : teamAttedanceModel?.status == "Failed" ||
                          filteredTeamMembers
                              .every((member) => member.status != "Approved")
                      ? Column(
                          children: [
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              child: tds
                                                                      ...
                                                                      tds.faceImage !=
                                                                          "" &&
                                                                      tds.faceImage !=
                                                                          "https://rapi.railtech.co.in/"&& tds.status!="Rejected"
                                                                  ? ClipRRect(
                                                                      child: Image
                                                                          .network(
                                                                        (tds.faceImage
