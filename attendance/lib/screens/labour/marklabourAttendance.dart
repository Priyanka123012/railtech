...
class MarkLabourAttendace extends StatefulWidget {
  const MarkLabourAttendace({super.key});

  @override
  State<MarkLabourAttendace> createState() => _MarkLabourAttendaceState();
}

class _MarkLabourAttendaceState extends State<MarkLabourAttendace> {
  ...
  Future<MultiFaceInput?> getFaceDataByEmpId() async {
    ...
    List<String>? savedFaces = prefs.getStringList('');
          ...
          child: Column(
            children: [
              ...
              isLoading == true
                  ...
                  : teamAttedanceModel?.status == "Failed"||filteredTeamMembers.every((member) => member.faceImage64 =="")
                                    ...
                                    return Column(
                                      children: [
                                        InkWell(
                                          ...
                                          //             // LaboursDetails(
                                          //             //     // filteredTeamMembers[index].labourId.toString(),
                                          //             //     //    filteredTeamMembers[index].fullName,
                                          //             //     //    filteredTeamMembers[index].eMPId,
                                                          
                                          //             //      lobourId:   tds.labourId ??"",
                                          //             //     fullname: tds
                                          //             //             .fullName ??
                                          //             //         "Default Name",
                                          //             //     EmployeeId:
